...
== 4.1.7 / Oct 11 2017
Update to model 4.1.39 and metamodel 1.1.14:
 ...
 * Use select of pycurl multi object.

== 4.1.6 / Jul 7 2017
Bug fixes:

 * Fix parsing of multi-byte UTF-8 characters
   https://bugzilla.redhat.com/1461060[#1461060].
 ...
 * Set HTTPAUTH_GSSNEGOTIATE for Curl not CurlMulti
   https://bugzilla.redhat.com/1459220[#1459220].
 ...
 * Depend on python PyCurl version 7.43.0-6 on fc25
   https://bugzilla.redhat.com/1456666[#1456666].
